...
g_class2color = {'Drilling rods':	[0,255,0],
                 'Pin':	[255,0,0],
                 'ground':	[23,27,252],
                 'sundries':  [85,85,0],
                 'tunnel':  [170,0,255],
                 'Drilling rig':  [156,0,0],
                 'Power head':  [8,109,69],
                 'Stabilizer':  [176,176,0],
                 'hole':     [170,85,0]} 
g_easy_view_labels = [0,1,2,3,4,5,6,7,8]
...
def collect_point_label(anno_path, out_filename, txtname,file_format='numpy'):
